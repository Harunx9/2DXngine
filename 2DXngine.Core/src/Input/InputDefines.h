...
#define KEYBOARD_SERVICE_NAME "KEYBOARD_SERVICE"
//From https://github.com/alexdantas/sdl2-platformer
...
enum MouseButtons
{
    LEFT_BTN = SDL_BUTTON_LEFT,
    MIDDLE_BTN = SDL_BUTTON_MIDDLE,
    RIGHT_BTN = SDL_BUTTON_RIGHT,
    X1_BTN = SDL_BUTTON_X1,
    X2_BTN = SDL_BUTTON_X2,
};
